...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["id-bulan"]) && isset($_POST["id-pekerjaan"]) && isset($_POST["nama-orang"])) {
        ...
        if (getDataOrangByBulanIdPekerjaanNamaOrang($idBulan, $idPekerjaan, $namaOrang, 1)) {
            unset($dataResultQuery);
            $dataResultQuery = array();
            $dataResultQuery = getDataOrangByBulanIdPekerjaanNamaOrang($idBulan, $idPekerjaan, $namaOrang, 1);
        } else {
            echo '<script language="javascript">';
        ...
        if (mencariSeluruhAnggotaKeluarga($namaOrang, 1)) {
            unset($dataResultQuery);
            $dataResultQuery = array();
            $dataResultQuery = mencariSeluruhAnggotaKeluarga($namaOrang, 1);
        } else {
            echo '<script language="javascript">';
            echo 'alert("Data Tidak Ditemukan !!")';
            echo '</script>';
                    ...
                    <div class="page-title">
                        <div class="">
                            <div class="col-md-12 col-sm-12 p-0 mt-2 mb-2 p-0 m-0">
                                <form method="POST" action="/data-jemaat/production/table_data_dak_satu.php" novalidate>
                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel pl-0 pr-0">
                                <div class="x_title pl-3">
                                    <h2>List Data Jamaat Lingkungan I</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card-box table-responsive">
                                                ...
                                                <table id="datatable-buttons" class="table table-bordered bulk_action" style="width:100%; text-align: center; font-size: 12px;">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($dataResultQuery as $row) { ?>
                                                            <tr>
                                                                ...
                                                                <td style="vertical-align: middle;"><?php echo  mencariNamaKepalaKeluarga($row['nkk_orang']) . '(' . $row['status_orang'] . ')'; ?></td>
                                                                ...
                                                                <td style="vertical-align: middle;">
                                                                    ...
                                                                    <a onclick="return  confirm('do you want to delete Y/N')" href="table_data_dak_satu.php?id-orang=<?php echo $row["id_orang"]; ?>"><button type="button" class="btn btn-danger" style="font-size: 12px !important;"><i class="fa fa-remove"></i> Hapus</button></a>
                                                                </td>
