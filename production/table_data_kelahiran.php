...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["id-bulan"]) && isset($_POST["nama-orang"])) {
        $idBulan = (int)($_POST["id-bulan"]);
        $namaOrang = $_POST["nama-orang"];
        if (getDataOrangByBulanNamaOrang($idBulan, $namaOrang)) {
            $dataResultQuery = getDataOrangByBulanNamaOrang($idBulan, $namaOrang);
        } else {
            echo '<script language="javascript">';
                    ...
                    <div class="page-title">
                        <div class="">
                            <div class="col-md-12 col-sm-12 p-0 mt-2 mb-2 p-0 m-0">
                                <form method="POST" action="/data-jemaat/production/table_data_kelahiran.php" novalidate>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($dataResultQuery as $row) { ?>
                                                            <tr>
                                                                ...
                                                                <td style="vertical-align: middle;"><?php echo getAge($row['tl_orang']); ?></td>
                                                                <td style="vertical-align: middle;"><?php echo getAge($row['tl_orang']) + 1; ?></td>
