...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["id-bulan"]) && isset($_POST["id-pekerjaan"]) && isset($_POST["nama-orang"])) {
        ...
        if (getDataOrangByBulanIdPekerjaanNamaOrang($idBulan, $idPekerjaan, $namaOrang, 2)) {
            unset($dataResultQuery); // $foo is gone
            $dataResultQuery = array();
            $dataResultQuery = getDataOrangByBulanIdPekerjaanNamaOrang($idBulan, $idPekerjaan, $namaOrang, 2);
        } else {
            echo '<script language="javascript">';
        ...
        if (mencariSeluruhAnggotaKeluarga($namaOrang, 2)) {
            unset($dataResultQuery); // $foo is gone
            $dataResultQuery = array();
            $dataResultQuery = mencariSeluruhAnggotaKeluarga($namaOrang, 2);
        } else {
            echo '<script language="javascript">';
            echo 'alert("Data Tidak Ditemukan !!")';
            echo '</script>';
                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel pl-0 pr-0">
                                <div class="x_title pl-3">
                                    <h2>List Data Jamaat Lingkungan II</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class="row">
